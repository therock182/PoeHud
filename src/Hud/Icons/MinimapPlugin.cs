...
namespace PoeHUD.Hud.Icons
{
    public class MinimapPlugin : Plugin<MapIconsSettings>
    {
        ...
        public override void Render()
        {
            ...
            RectangleF clientRect = smallMinimap.GetClientRect();
            ...
            foreach (MapIcon icon in getIcons().Where(x => x.IsVisible()))
            {
                ...
                Vector2 point = minimapCenter + MapIcon.deltaInWorldToMinimapDelta(icon.WorldPosition - playerPos, diag, SCALE, (iZ - pPosZ) / 20);
